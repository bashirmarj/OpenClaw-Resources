...
# Updated to use volumetric subtraction for CRASH-FREE recognition
try:
    ...
    logger.info("✅ Volumetric feature recognizer initialized (NO MapShapesAndAncestors)")
except Exception as e:
...
def recognize_features_ml(shape, correlation_id: str):
    ...
    try:
        ...
        logger.info(f"[{correlation_id}] ✅ Volumetric: {features['num_features_detected']} features, confidence={avg_confidence:.2f}")
